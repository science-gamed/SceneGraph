(function ( i ) {
	...
	//
	//   var matrix = new i.Matrix();   <--- if we don't specify the matrix elements, we get the identity matrix.

	i.Matrix = function ( a, b, c, d, e, f ) {
	...
	i.Matrix.prototype = {
		...
		multiply: function ( o ) {
			var
				m1 = this.elements,
				m2 = ( o instanceof i.Matrix ) ? o.elements : arguments,
				m3 = new i.Matrix(),
		...
		decompose: function () {
			this.decomposed = i.Matrix.decompose( this );
		...
		clone: function () {
			...
			return new i.Matrix( m[0], m[1], m[2], m[3], m[4], m[5] );
		},
	...
	i.Matrix.fromString = function ( string ) {
		var
			transformTypes = [
				'translate',
				'translateX',
	...
	i.Matrix.decompose = function ( a, b, c, d, e, f ) {
